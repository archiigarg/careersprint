            ...
            <li key={video.id.videoId || video.id.playlistId} className="mb-6">
              <a
                href={`https://www.youtube.com/watch?v=${
                  video.id.videoId || video.id.playlistId
                }`}
                target="_blank"
                rel="noopener noreferrer"
                className="block hover:bg-orange-100 p-3 rounded-lg transition duration-300 ease-in-out group"
              >
                <img
                ...
                />
                <span className="block mt-2 text-lg font-semibold line-clamp-2 text-white group-hover:text-orange-500">
                  {video.snippet.title}
                </span>
              </a>
            </li>
